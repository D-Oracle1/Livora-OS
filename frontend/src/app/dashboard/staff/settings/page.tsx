              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  {[
                    ...
                    { key: 'tasks', label: 'Task Assignments', description: 'When you are assigned a new task' },
                    { key: 'leave', label: 'Leave Updates', description: 'Updates on your leave requests' },
                    { key: 'payroll', label: 'Payroll Notifications', description: 'When payslips are available' },
